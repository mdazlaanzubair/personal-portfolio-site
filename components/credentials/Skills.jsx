const Skills = () => {
  ...
  return (
    <div className="flex flex-col px-5 shadow-lg bg-base-100 lg:px-16 py-5 lg:py-16 gap-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-5">
        {skills.map((skill, index) => {
          ...
          return (
            <div
              key={index}
              className={`group relative w-full px-5 py-10 flex flex-col justify-center bg-base-100 shadow hover:shadow-lg ${
